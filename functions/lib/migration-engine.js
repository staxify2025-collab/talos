...
exports.processMigrationStep = processMigrationStep;
...
async function processMigrationStep(req) {
    ...
    try {
        ...
        const { cacheName, isNew } = await (0, cache_manager_1.getOrCreateCache)(req.tenantId, req.schemaId, req.targetScreenshotBase64, MIGRATION_SYSTEM_INSTRUCTION, mappingDescription);
        ...
        const avgConfidence = parsed.actions.length > 0
            ? parsed.actions.reduce((acc, a) => acc + a.confidence, 0) / parsed.actions.length
            : 1;
